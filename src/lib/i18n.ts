...
export const en: Translations = {
  ...
  predictions: {
    ...
    scoringTitle: 'Scoring', scoringText: 'Group stage: exact score 3 pts · correct winner/draw 1 pt. Knockout decided in regulation: same rule. Knockout that needs extra time: each phase scores separately and stacks — 90′ draw (3 pts exact / 1 pt correct draw, shown as "90′ X–Y" once verified) + extra-time score (1–3 pts) + penalties, if it goes there (1 pt correct winner, +1 more for the exact shootout score).',
...
export const pt: Translations = {
  ...
  predictions: {
    ...
    scoringTitle: 'Pontuação', scoringText: 'Fase de grupos: placar exato 3 pts · vencedor/empate correto 1 pt. Mata-mata decidido no tempo normal: mesma regra. Mata-mata que vai à prorrogação: cada etapa pontua separadamente e se acumula — empate nos 90′ (3 pts exato / 1 pt empate correto, exibido como "90′ X–Y" quando confirmado) + placar da prorrogação (1–3 pts) + pênaltis, se chegar lá (1 pt vencedor correto, +1 pelo placar exato da disputa).',
...
export const es: Translations = {
  ...
  predictions: {
    ...
    scoringTitle: 'Puntuación', scoringText: 'Fase de grupos: resultado exacto 3 pts · ganador/empate correcto 1 pt. Eliminatoria decidida en tiempo reglamentario: misma regla. Eliminatoria que va a la prórroga: cada etapa puntúa por separado y se acumula — empate a los 90′ (3 pts exacto / 1 pt empate correcto, mostrado como "90′ X–Y" al confirmarse) + marcador de la prórroga (1–3 pts) + penales, si llega ahí (1 pt ganador correcto, +1 por el marcador exacto de la tanda).',
